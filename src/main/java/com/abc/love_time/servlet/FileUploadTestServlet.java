...
@WebServlet("/api/test/file-upload")
@MultipartConfig(
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (!isValidImageType(contentType)) {
                out.print("{\"success\": false, \"message\": \"仅支持图片格式（jpg, jpeg, png, gif）\"}");
                return;
            }
            ...
            System.out.println("[FileUploadTestServlet] 文件上传路径: " + filePath);
            System.out.println("[FileUploadTestServlet] 文件是否存在: " + fileExists);
        } catch (Exception e) {
            e.printStackTrace();
